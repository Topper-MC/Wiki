...
> and [VarBlocks](https://www.spigotmc.org/resources/varblocks.120327/)

## Create a Top Skull

1. Prepare a skull template named `jump_skull` that returns the UUID of the player at the specific `{index}` of the
   `jump` leaderboard
...
1. Prepare a sign template named `jump_sign` that displays the player's name and value at the specific `{index}` of the
   `jump` leaderboard
