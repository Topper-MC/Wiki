...
import MiniPlaceholderForm from '~/components/forms/MiniPlaceholderForm.vue';
...
<Tabs syncKey="platform">
  <TabItem label="SpigotMC">
    <MiniPlaceholderForm platform="spigot" client:load />
  </TabItem>
  <TabItem label="FabricMC">
    <MiniPlaceholderForm platform="fabric" client:load />
  </TabItem>
</Tabs>
