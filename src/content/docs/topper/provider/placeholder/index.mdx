...
import PlaceholderForm from '~/components/forms/PlaceholderForm.vue';
...
<Tabs syncKey="platform">
  <TabItem label="SpigotMC">
    <PlaceholderForm platform="spigot" client:load />
  </TabItem>
  <TabItem label="FabricMC">
    <PlaceholderForm platform="fabric" client:load />
  </TabItem>
</Tabs>
