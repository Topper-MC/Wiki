---
title: Statistic
description: Use Minecraft statistics as leaderboard values with the Statistic Value Provider.
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';
import StatisticForm from '@site/src/components/forms/StatisticForm';
...
<Tabs groupId="platform">
  <TabItem value="spigot" label="SpigotMC">
    <StatisticForm platform="spigot" />
  </TabItem>
  <TabItem value="fabric" label="FabricMC">
    <StatisticForm platform="fabric" />
  </TabItem>
</Tabs>
