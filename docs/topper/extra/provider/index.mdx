...
description: Customize value providers with async mode, default values, display formatting, and offline support.
---
...
You can set a default [Value Display](/topper/extra/value_display/) that will be applied to all the queries by setting the `default-value-display` setting.
